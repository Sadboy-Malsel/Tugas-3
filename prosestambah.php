<?php
    ...
    elseif(empty($password)){
        ...
        if($insert){
            echo "<script>alert('Sukses Menambahkan Data Mahasiswa');location.href='datajadwal.php';</script>";
                    }
        else{
            echo "<script>alert('Gagal Menambahkan Mahasiswa');location.href='tambahjadwal.php';</script>";
